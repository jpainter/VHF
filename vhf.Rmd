...
```{r prefets_dot, fig.cap="Cas d'Ebola pendant le dernier 21 jours, Guinee"}
g = ggplot( ) + theme_map +
  geom_polygon(data= map.data.p,
               aes(x=long, y=lat, group=group), 
               fill="grey90", color = 'grey10') + 
  geom_point(data= map.data.p.c, aes(x=V1, y=V2, size = Cases3, alpha = Cases3), 
             color = "red") 
g
ggsave('PrefetMap4.png')
```
