...
cases.guinea = case_data %>% 
  select( GlobalRecordId, ID, ThisCaseIsAlsoContact,
          ...
          StatusAsOfCurrentDate, EpiCaseDef , FinalStatus,
...
```{r isolation_survival_rate, fig.cap='Survival rate (loess) by days to isolation, Guinea'}
...
```{r isolation_survival_rate_region, fig.cap='Survival rate (loess) by days to isolation, Guinea'}
